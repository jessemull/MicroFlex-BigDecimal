...
import com.github.jessemull.microflexbigdecimal.stat.SampleVariance;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the sample variance big decimal class.
 * 
 * @author Jesse L. Mull
...
public class SampleVarianceWeightsTest {
	...
	private static SampleVariance variance = new SampleVariance();
