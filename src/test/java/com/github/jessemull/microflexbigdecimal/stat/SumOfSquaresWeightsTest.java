...
import com.github.jessemull.microflexbigdecimal.stat.SumOfSquares;
...
public class SumOfSquaresWeightsTest {
	...
	private static SumOfSquares sum = new SumOfSquares();
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = sum.plate(plate, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, weights, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(array, weights, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(collection, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = sum.platesAggregated(arrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = sum.set(plate.dataSet(), ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, weights, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArray, weights, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(collection, weightsIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = sum.setsAggregated(setArrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
