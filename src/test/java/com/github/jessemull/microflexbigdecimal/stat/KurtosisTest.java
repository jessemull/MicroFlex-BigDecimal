...
import com.github.jessemull.microflexbigdecimal.stat.Kurtosis;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the kurtosis big decimal class.
 * 
 * @author Jesse L. Mull
...
public class KurtosisTest {
    ...
    public void testPlate() {
		...
		for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> returnedMap = kurtosis.plate(plate, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(array, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = kurtosis.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = kurtosis.set(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = kurtosis.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testWell() {
		...
		for(Plate plate : array) {
			...
			for(Well well : plate) {
				...
				BigDecimal returned = kurtosis.well(well, mc);					
				BigDecimal result = new BigDecimal(resultDouble);
