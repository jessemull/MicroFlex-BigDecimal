...
import com.github.jessemull.microflexbigdecimal.stat.PopulationVariance;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the population variance big decimal class.
 * 
 * @author Jesse L. Mull
...
public class PopulationVarianceWeightsTest {
	...
	private static PopulationVariance variance = new PopulationVariance();
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = variance.plate(plate, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedPlate() {
    	...
    	for(Plate plate : array) {
    		...
    		BigDecimal aggregatedReturned = variance.platesAggregated(plate, weights, mc);
    ...
    public void testAggregatedPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.platesAggregated(plate, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(collection, weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(arrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = variance.set(plate.dataSet(), ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);
    ...
    public void testAggregatedSet() {
    	...
    	for(Plate plate : array) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.setsAggregated(plate.dataSet(), weights, mc);
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.setsAggregated(plate.dataSet(), weightsIndices, begin, end - begin, mc);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(collection, weightsIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(setArrayIndices, weightsIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testWellIndices() {
    	...
    	for(Plate plate : arrayIndices) {
			...
			for(Well well : plate) {
				...
				BigDecimal returned = variance.well(well, ArrayUtils.subarray(weightsIndices, begin, end), begin, end - begin, mc);					
				BigDecimal result = new BigDecimal(resultDouble, mc);
