...
import com.github.jessemull.microflexbigdecimal.stat.Min;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the min big decimal class.
 * 
 * @author Jesse L. Mull
...
public class MinTest {
	...
	private static BigDecimal maxValue = new BigDecimal(10);    // Minimum big decimal value for wells
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = min.plate(plate, begin, end - begin);
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = min.set(plate.dataSet());
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = min.set(plate.dataSet(), begin, end - begin);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = min.setsAggregated(collection, begin, end - begin);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = min.setsAggregated(setArrayIndices, begin, end - begin);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
