...
/**
 * This class tests the methods in the variance big decimal class.
 * 
 * @author Jesse L. Mull
...
public class PopulationVarianceTest {
	...
	public void testConstructor() {
		PopulationVariance test = new PopulationVariance();
		assertNotNull(test);
	}
    ...
    public void testPlate() {
		...
		for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> returnedMap = variance.plate(plate, mc);
    ...
    public void testAggregatedPlate() {
    	...
    	for(Plate plate : array) {
    		...
    		BigDecimal aggregatedReturned = variance.platesAggregated(plate, mc);
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(array, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testAggregatedPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    	    ...
    	    List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.platesAggregated(plate, begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = variance.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testAggregatedSet() {
    	...
    	for(Plate plate : array) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.setsAggregated(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(setArray, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = variance.setsAggregated(plate.dataSet(), begin, end - begin, mc);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = variance.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
