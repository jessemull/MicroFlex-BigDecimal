...
import com.github.jessemull.microflexbigdecimal.stat.Percentile;
...
public class PercentileTest {
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = percentile.platesAggregated(collection, begin, end - begin, inputPercentile);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = percentile.platesAggregated(arrayIndices, begin, end - begin, inputPercentile);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = percentile.set(plate.dataSet(), begin, end - begin, inputPercentile);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = percentile.setsAggregated(collection, begin, end - begin, inputPercentile);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = percentile.setsAggregated(setArrayIndices, begin, end - begin, inputPercentile);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
