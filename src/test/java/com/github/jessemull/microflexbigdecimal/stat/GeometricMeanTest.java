...
import com.github.jessemull.microflexbigdecimal.stat.GeometricMean;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the mean big decimal class.
 * 
 * @author Jesse L. Mull
...
public class GeometricMeanTest {
	...
	private static BigDecimal maxValue = new BigDecimal(3);     // Maximum big decimal value for wells
	...
	public void testConstructor() {
		GeometricMean test = new GeometricMean();
		assertNotNull(test);
	}
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = mean.plate(plate, begin, end - begin, mc);
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = mean.set(plate.dataSet(), begin, end - begin, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(setArray, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
		...
		WellSet[] array = collection.toArray(new WellSet[collection.size()]);
		
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = mean.setsAggregated(array, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
