...
import com.github.jessemull.microflexbigdecimal.stat.Skewness;
import com.github.jessemull.microflexbigdecimal.util.RandomUtil;

/**
 * This class tests the methods in the skewness big decimal class.
 * 
 * @author Jesse L. Mull
...
public class SkewnessTest {
    ...
    public void testPlate() {
		...
		for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> returnedMap = skewness.plate(plate, mc);
    ...
    public void testPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = skewness.plate(plate, begin, end - begin, mc);
    ...
    public void testAggregatedPlate() {
    	...
    	for(Plate plate : array) {
    		...
    		BigDecimal aggregatedReturned = skewness.platesAggregated(plate, mc);
			...
			double resultAggregatedDouble = statAggregated.getSkewness();
    ...
    public void testAggregatedPlateCollection() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = skewness.platesAggregated(collection, mc);
    ...
    public void testAggregatedPlateArray() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = skewness.platesAggregated(array, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testAggregatedPlateIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    	    ...
    	    List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = skewness.platesAggregated(plate, begin, end - begin, mc);
    ...
    public void testAggregatedPlateCollectionIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = skewness.platesAggregated(collection, begin, end - begin, mc);
    ...
    public void testAggregatedPlateArrayIndices() {
    	...
    	Map<Plate, BigDecimal> aggregatedReturnedMap = skewness.platesAggregated(arrayIndices, begin, end - begin, mc);
    	Map<Plate, BigDecimal> aggregatedResultMap = new TreeMap<Plate, BigDecimal>();
    ...
    public void testSet() {
    	...
    	for(Plate plate : array) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = skewness.set(plate.dataSet(), mc);
    ...
    public void testSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		Map<Well, BigDecimal> resultMap = new TreeMap<Well, BigDecimal>();
    		Map<Well, BigDecimal> returnedMap = skewness.set(plate.dataSet(), begin, end - begin, mc);
    ...
    public void testAggregatedSet() {
    	...
    	for(Plate plate : array) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = skewness.setsAggregated(plate.dataSet(), mc);
    ...
    public void testAggregatedSetCollection() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = skewness.setsAggregated(collection, mc);
    ...
    public void testAggregatedSetArray() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = skewness.setsAggregated(setArray, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetIndices() {
    	...
    	for(Plate plate : arrayIndices) {
    		...
    		List<BigDecimal> resultList = new ArrayList<BigDecimal>();
    		BigDecimal aggregatedReturned = skewness.setsAggregated(plate.dataSet(), begin, end - begin, mc);
    ...
    public void testAggregatedSetCollectionIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = skewness.setsAggregated(collection, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
    ...
    public void testAggregatedSetArrayIndices() {
    	...
    	Map<WellSet, BigDecimal> aggregatedReturnedMap = skewness.setsAggregated(setArrayIndices, begin, end - begin, mc);
    	Map<WellSet, BigDecimal> aggregatedResultMap = new TreeMap<WellSet, BigDecimal>();
