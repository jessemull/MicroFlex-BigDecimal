...
import com.github.jessemull.microflexbigdecimal.math.Division;
...
/**
 * This class tests the methods in the division big decimal class.
 * 
 * @author Jesse L. Mull
...
/* ---------------------------- Local fields ---------------------------- */
    ...
    /**
     * Tests the division of two wells.
     */
	@Test
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> returned = division.wells(well1[j], well2[j], mc);
    			List<BigDecimal> returnedUneven = division.wells(well1[j], wellUneven[j], mc);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(list2.get(k), mc));
    				resultUneven.add(list1.get(k).divide(unevenList.get(k), mc));
    			}
    ...
    /**
     * Tests the division of two wells using indices.
     */
	@Test
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wells(well1[j], well2[j], begin, end - begin, mc);
    			List<BigDecimal> returnedUneven = division.wells(well1[j], wellUneven[j], begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of two wells.
     */
	@Test
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wellsStrict(well1[j], well2[j], mc);
    			List<BigDecimal> returnedUneven = division.wellsStrict(well1[j], wellUneven[j], mc);
    ...
    /**
     * Tests the strict division of two wells using indices.
     */
	@Test
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wellsStrict(well1[j], well2[j], begin, end - begin, mc);
    			List<BigDecimal> returnedUneven = division.wellsStrict(well1[j], wellUneven[j], begin, end - begin, mc);
    ...
    /**
     * Tests the division of a constant to a well.
     */
	@Test
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> list1 = well1[j].data();
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wells(well1[j], constantBigDecimal, mc);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(constantBigDecimal, mc));
    			}
    ...
    public void testWellArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wells(well1[j], array, mc);
    			List<BigDecimal> returnedUneven = division.wells(well1[j], arrayUneven, mc);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).divide(array[k], mc));
    				resultUneven.add(list1.get(k).divide(arrayUneven[k], mc));
    			}
    ...
    public void testWellArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wells(well1[j], array, begin, end - begin, mc);
    			List<BigDecimal> returnedUneven = division.wells(well1[j], arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a collection to a well.
     */
	@Test
    ...
    /**
     * Tests the division of a collection to a well using indices.
     */
    @Test
    ...
    public void testWellStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wellsStrict(well1[j], array, mc);
    			List<BigDecimal> returnedUneven = division.wellsStrict(well1[j], arrayUneven, mc);
    ...
    public void testWellStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = division.wellsStrict(well1[j], array, begin, end - begin, mc);
    			List<BigDecimal> returnedUneven = division.wellsStrict(well1[j], arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of a collection to a well.
     */
    @Test
    ...
    /**
     * Tests the division of two plates.
     */
    @Test
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, plate2, mc);
    		Plate returnedPlateUneven = division.plates(plate1, plateUneven, mc);
    ...
    /**
     * Tests the division of two plates using indices.
     */
    @Test
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.plates(plate1, plate2, begin, end - begin, mc);
    		Plate returnedPlateUneven = division.plates(plate1, plateUneven, begin, end - begin, mc);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    /**
     * Tests the strict division of two plates.
     */
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.platesStrict(plate1, plate2, mc);
    		Plate returnedPlateUneven = division.platesStrict(plate1, plateUneven, mc);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    /**
     * Tests the strict division of two plates using indices.
     */
    @Test
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = division.platesStrict(plate1, plate2, begin, end - begin, mc);
    		Plate returnedPlateUneven = division.platesStrict(plate1, plateUneven, begin, end - begin, mc);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    /**
     * Tests the division of a constant to a plate.
     */
    @Test
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(BigDecimal bd : well.data()) {
    				list.add(bd.divide(randomBigDecimal, mc));
    			}
    			
    			result.add(new Well(well.row(), well.column(), list));
    		}

    		Plate returnedPlate = division.plates(plate1, randomBigDecimal, mc);
    ...
    /**
     * Tests the division of an array to a plate.
     */
    @Test
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < array.length; index++) {
    				wellResult.add(list.get(index).divide(array[index], mc));
    			}
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < arrayUneven.length; index++) {
    				wellResult.add(list.get(index).divide(arrayUneven[index], mc));
    			}
    		...
    		Plate returned = division.plates(plate1, array, mc);
    		Plate returnedUneven = division.plates(plate1, arrayUneven, mc);
    ...
    /**
     * Tests the division of an array to a plate using indices.
     */
    @Test
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.plates(plate1, array, begin, end - begin, mc);
    		Plate returnedUneven = division.plates(plate1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a collection to a plate.
     */
    @Test
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputList.size(); index++) {
    				wellResult.add(list.get(index).divide(inputList.get(index), mc));
    			}
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputListUneven.size(); index++) {
    				wellResult.add(list.get(index).divide(inputListUneven.get(index), mc));
    			}
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.plates(plate1, inputList, mc);
    		Plate returnedUneven = division.plates(plate1, inputListUneven, mc);
    ...
    /**
     * Tests the division of a collection to a plate using indices.
     */
    @Test
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = division.plates(plate1, inputList, begin, end - begin, mc);
    		Plate returnedUneven = division.plates(plate1, inputListUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of an array to a plate.
     */
    @Test
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, array, mc);
    		Plate returnedUneven = division.platesStrict(plate1, arrayUneven, mc);
    ...
    /**
     * Tests the strict division of an array to a plate using indices.
     */
    @Test
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, array, begin, end - begin, mc);
    		Plate returnedUneven = division.platesStrict(plate1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of a collection to a plate.
     */
    @Test
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = division.platesStrict(plate1, inputList, mc);
    		Plate returnedUneven = division.platesStrict(plate1, inputListUneven, mc);
    ...
    /**
     * Tests the strict division of a collection to a plate using indices.
     */
    @Test
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = division.platesStrict(plate1, inputList, begin, end - begin, mc);
    		Plate returnedUneven = division.platesStrict(plate1, inputListUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a two sets.
     */
    @Test
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, false);
    		WellSet returned = division.sets(set1, set2, mc);
    		WellSet returnedUneven = division.sets(set1, setUneven, mc);
    ...
    /**
     * Tests the division of two sets using indices.
     */
    @Test
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSet returned = division.sets(set1, set2, begin, end - begin, mc);
    		WellSet returnedUneven = division.sets(set1, setUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of two sets.
     */
    @Test
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, true);
    		WellSet returned = division.setsStrict(set1, set2, mc);
    		WellSet returnedUneven = division.setsStrict(set1, setUneven, mc);
    ...
    /**
     * Tests the strict division of two sets using indices.
     */
    @Test
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSet returned = division.setsStrict(set1, set2, begin, end - begin, mc);
    		WellSet returnedUneven = division.setsStrict(set1, setUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a constant to a set.
     */
    @Test
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set, randomBigDecimal, mc);
    ...
    /**
     * Tests the division of an array to a set.
     */
    @Test
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, array, mc);
    		WellSet returnedUneven = division.sets(set1, arrayUneven, mc);
    ...
    /**
     * Tests the division of an array to a set using indices.
     */
    @Test
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, array, begin, end - begin, mc);
    		WellSet returnedUneven = division.sets(set1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a collection to a set.
     */
    @Test
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, inputList, mc);
    		WellSet returnedUneven = division.sets(set1, inputListUneven, mc);
    ...
    /**
     * Tests the division of a collection to a set using indices.
     */
    @Test
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.sets(set1, inputList, begin, end - begin, mc);
    		WellSet returnedUneven = division.sets(set1, inputListUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of an array to a set.
     */
    @Test
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, array, mc);
    		WellSet returnedUneven = division.setsStrict(set1, arrayUneven, mc);
    ...
    /**
     * Tests the strict division of an array to a set using indices.
     */
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, array, begin, end - begin, mc);
    		WellSet returnedUneven = division.setsStrict(set1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of a collection to a set.
     */
    @Test
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, inputList, mc);
    		WellSet returnedUneven = division.setsStrict(set1, inputListUneven, mc);
    ...
    /**
     * Tests the strict division of a collection to a set using indices.
     */
    @Test
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = division.setsStrict(set1, inputList, begin, end - begin, mc);
    		WellSet returnedUneven = division.setsStrict(set1, inputListUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of two stacks.
     */
    @Test
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, stack2, mc);
	    	Stack returnedUneven = division.stacks(stack1, stackUneven, mc);
    ...
    /**
     * Tests the division of two stack using indices.
     */
    @Test
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, stack2, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacks(stack1, stackUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of two stacks.
     */
    @Test
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, stack2, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, stackUneven, mc);
    ...
    /**
     * Tests the strict division of two stacks using indices.
     */
    @Test
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, stack2, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, stackUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a constant to a stack.
     */
    @Test
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	while(stackIter1.hasNext()) {
	    		...
	    		for(Well well : plate) {
	    			...
	    			for(BigDecimal bd : well) {
	    				resultList.add(bd.divide(randomBigDecimal, mc));
	    			}
	    	...
	    	Stack returned = division.stacks(stack1, randomBigDecimal, mc);
    ...
    /**
     * Tests the division of an array to a stack.
     */
    @Test
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, array, mc);
	    	Stack returnedUneven = division.stacks(stack1, arrayUneven, mc);
    ...
    /**
     * Tests the division of an array to a stack using indices.
     */
    @Test
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, array, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacks(stack1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the division of a collection to a stack.
     */
    @Test
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, inputList, mc);
	    	Stack returnedUneven = division.stacks(stack1, inputListUneven, mc);
    ...
    /**
     * Tests the division of a collection to a stack using indices.
     */
    @Test
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacks(stack1, inputList, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacks(stack1, inputListUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of an array to a stack.
     */
    @Test
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, array, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, arrayUneven, mc);
    ...
    /**
     * Tests the strict division of an array to a stack using indices.
     */
    @Test
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, array, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, arrayUneven, begin, end - begin, mc);
    ...
    /**
     * Tests the strict division of a collection to a stack.
     */
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, inputList, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, inputListUneven, mc);
    ...
    /**
     * Tests the strict division of a collection to a stack using indices.
     */
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = division.stacksStrict(stack1, inputList, begin, end - begin, mc);
	    	Stack returnedUneven = division.stacksStrict(stack1, inputListUneven, begin, end - begin, mc);
