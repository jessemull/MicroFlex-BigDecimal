...
import com.github.jessemull.microflexbigdecimal.math.Addition;
...
/**
 * This class tests the methods in the addition big decimal class.
 * 
 * @author Jesse L. Mull
...
/* ---------------------------- Local fields ---------------------------- */
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> returned = addition.wells(well1[j], well2[j]);
    			List<BigDecimal> returnedUneven = addition.wells(well1[j], wellUneven[j]);
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wells(well1[j], well2[j], begin, end - begin);
    			List<BigDecimal> returnedUneven = addition.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wellsStrict(well1[j], well2[j]);
    			List<BigDecimal> returnedUneven = addition.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<BigDecimal> returnedUneven = addition.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> list1 = well1[j].data();
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wells(well1[j], constantBigDecimal);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).add(constantBigDecimal));
    			}
    ...
    public void testWellArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wells(well1[j], array);
    			List<BigDecimal> returnedUneven = addition.wells(well1[j], arrayUneven);
    ...
    public void testWellArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wells(well1[j], array, begin, end - begin);
    			List<BigDecimal> returnedUneven = addition.wells(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testWellStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wellsStrict(well1[j], array);
    			List<BigDecimal> returnedUneven = addition.wellsStrict(well1[j], arrayUneven);
    ...
    public void testWellStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = addition.wellsStrict(well1[j], array, begin, end - begin);
    			List<BigDecimal> returnedUneven = addition.wellsStrict(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = addition.plates(plate1, plate2);
    		Plate returnedPlateUneven = addition.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = addition.plates(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = addition.plates(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = addition.platesStrict(plate1, plate2);
    		Plate returnedPlateUneven = addition.platesStrict(plate1, plateUneven);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = addition.platesStrict(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = addition.platesStrict(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(BigDecimal bd : well.data()) {
    				list.add(bd.add(randomBigDecimal));
    			}
    			
    			result.add(new Well(well.row(), well.column(), list));
    		}

    		Plate returnedPlate = addition.plates(plate1, randomBigDecimal);
    ...
    public void testPlateArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returned = addition.plates(plate1, array);
    		Plate returnedUneven = addition.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = addition.plates(plate1, array, begin, end - begin);
    		Plate returnedUneven = addition.plates(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = addition.plates(plate1, inputList);
    		Plate returnedUneven = addition.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = addition.plates(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = addition.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = addition.platesStrict(plate1, array);
    		Plate returnedUneven = addition.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = addition.platesStrict(plate1, array, begin, end - begin);
    		Plate returnedUneven = addition.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = addition.platesStrict(plate1, inputList);
    		Plate returnedUneven = addition.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = addition.platesStrict(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = addition.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, false);
    		WellSet returned = addition.sets(set1, set2);
    		WellSet returnedUneven = addition.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSet returned = addition.sets(set1, set2, begin, end - begin);
    		WellSet returnedUneven = addition.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, true);
    		WellSet returned = addition.setsStrict(set1, set2);
    		WellSet returnedUneven = addition.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSet returned = addition.setsStrict(set1, set2, begin, end - begin);
    		WellSet returnedUneven = addition.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set, randomBigDecimal);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set1, array);
    		WellSet returnedUneven = addition.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set1, array, begin, end - begin);
    		WellSet returnedUneven = addition.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set1, inputList);
    		WellSet returnedUneven = addition.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.sets(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = addition.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.setsStrict(set1, array);
    		WellSet returnedUneven = addition.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.setsStrict(set1, array, begin, end - begin);
    		WellSet returnedUneven = addition.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.setsStrict(set1, inputList);
    		WellSet returnedUneven = addition.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = addition.setsStrict(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = addition.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, stack2);
	    	Stack returnedUneven = addition.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = addition.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, stack2);
	    	Stack returnedUneven = addition.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = addition.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	while(stackIter1.hasNext()) {
	    		...
	    		for(Well well : plate) {
	    			...
	    			for(BigDecimal bd : well) {
	    				resultList.add(bd.add(randomBigDecimal));
	    			}
	    	...
	    	Stack returned = addition.stacks(stack1, randomBigDecimal);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, array);
	    	Stack returnedUneven = addition.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, array, begin, end - begin);
	    	Stack returnedUneven = addition.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, inputList);
	    	Stack returnedUneven = addition.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacks(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = addition.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, array);
	    	Stack returnedUneven = addition.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, array, begin, end - begin);
	    	Stack returnedUneven = addition.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, inputList);
	    	Stack returnedUneven = addition.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = addition.stacksStrict(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = addition.stacksStrict(stack1, inputListUneven, begin, end - begin);
