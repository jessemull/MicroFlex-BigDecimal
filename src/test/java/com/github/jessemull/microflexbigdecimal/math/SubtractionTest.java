...
import com.github.jessemull.microflexbigdecimal.math.Subtraction;
...
/**
 * This class tests the methods in the subtraction big decimal class.
 * 
 * @author Jesse L. Mull
...
/* ---------------------------- Local fields ---------------------------- */
    ...
    public void testWells() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> returned = subtraction.wells(well1[j], well2[j]);
    			List<BigDecimal> returnedUneven = subtraction.wells(well1[j], wellUneven[j]);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).subtract(list2.get(k)));
    				resultUneven.add(list1.get(k).subtract(unevenList.get(k)));
    			}
    ...
    public void testWellsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wells(well1[j], well2[j], begin, end - begin);
    			List<BigDecimal> returnedUneven = subtraction.wells(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wellsStrict(well1[j], well2[j]);
    			List<BigDecimal> returnedUneven = subtraction.wellsStrict(well1[j], wellUneven[j]);
    ...
    public void testWellsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wellsStrict(well1[j], well2[j], begin, end - begin);
    			List<BigDecimal> returnedUneven = subtraction.wellsStrict(well1[j], wellUneven[j], begin, end - begin);
    ...
    public void testWellConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> list1 = well1[j].data();
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wells(well1[j], constantBigDecimal);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).subtract(constantBigDecimal));
    			}
    ...
    public void testWellArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wells(well1[j], array);
    			List<BigDecimal> returnedUneven = subtraction.wells(well1[j], arrayUneven);
    			
    			for(int k = 0; k < list1.size(); k++) {
    				result.add(list1.get(k).subtract(array[k]));
    				resultUneven.add(list1.get(k).subtract(arrayUneven[k]));
    			}
    ...
    public void testWellArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wells(well1[j], array, begin, end - begin);
    			List<BigDecimal> returnedUneven = subtraction.wells(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testWellStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wellsStrict(well1[j], array);
    			List<BigDecimal> returnedUneven = subtraction.wellsStrict(well1[j], arrayUneven);
    ...
    public void testWellStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(int j = 0; j < well1.length; j++) {
    			...
    			List<BigDecimal> result = new ArrayList<BigDecimal>();
    			List<BigDecimal> resultUneven = new ArrayList<BigDecimal>();
    			List<BigDecimal> returned = subtraction.wellsStrict(well1[j], array, begin, end - begin);
    			List<BigDecimal> returnedUneven = subtraction.wellsStrict(well1[j], arrayUneven, begin, end - begin);
    ...
    public void testPlates() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = subtraction.plates(plate1, plate2);
    		Plate returnedPlateUneven = subtraction.plates(plate1, plateUneven);
    ...
    public void testPlatesIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = subtraction.plates(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = subtraction.plates(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = subtraction.platesStrict(plate1, plate2);
    		Plate returnedPlateUneven = subtraction.platesStrict(plate1, plateUneven);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    ...
    public void testPlatesStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate returnedPlate = subtraction.platesStrict(plate1, plate2, begin, end - begin);
    		Plate returnedPlateUneven = subtraction.platesStrict(plate1, plateUneven, begin, end - begin);
    		Plate resultPlate = new Plate(plate1.rows(), plate2.columns(), result[0]);
    		Plate resultUnevenPlate = new Plate(plateUneven.rows(), plateUneven.columns(), result[1]);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(BigDecimal bd : well.data()) {
    				list.add(bd.subtract(randomBigDecimal));
    			}
    			
    			result.add(new Well(well.row(), well.column(), list));
    		}

    		Plate returnedPlate = subtraction.plates(plate1, randomBigDecimal);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < array.length; index++) {
    				wellResult.add(list.get(index).subtract(array[index]));
    			}
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < arrayUneven.length; index++) {
    				wellResult.add(list.get(index).subtract(arrayUneven[index]));
    			}
    		...
    		Plate returned = subtraction.plates(plate1, array);
    		Plate returnedUneven = subtraction.plates(plate1, arrayUneven);
    ...
    public void testPlateArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = subtraction.plates(plate1, array, begin, end - begin);
    		Plate returnedUneven = subtraction.plates(plate1, arrayUneven, begin, end - begin);
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputList.size(); index++) {
    				wellResult.add(list.get(index).subtract(inputList.get(index)));
    			}
    		...
    		for(Well well : set1) {
    			...
    			for(index = 0; index < list.size() && index < inputListUneven.size(); index++) {
    				wellResult.add(list.get(index).subtract(inputListUneven.get(index)));
    			}
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = subtraction.plates(plate1, inputList);
    		Plate returnedUneven = subtraction.plates(plate1, inputListUneven);
    ...
    public void testPlateCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = subtraction.plates(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = subtraction.plates(plate1, inputListUneven, begin, end - begin);
    ...
    public void testPlateStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = subtraction.platesStrict(plate1, array);
    		Plate returnedUneven = subtraction.platesStrict(plate1, arrayUneven);
    ...
    public void testPlateStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = subtraction.platesStrict(plate1, array, begin, end - begin);
    		Plate returnedUneven = subtraction.platesStrict(plate1, arrayUneven, begin, end - begin);
    ...
    public void testPlateStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		Plate resultPlate = new Plate(plate1.rows(), plate1.columns(), result);
    		Plate resultPlateUneven = new Plate(plate1.rows(), plate1.columns(), resultUneven);
    		Plate returned = subtraction.platesStrict(plate1, inputList);
    		Plate returnedUneven = subtraction.platesStrict(plate1, inputListUneven);
    ...
    public void testPlateStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
           ...
           for(Well well : set1) {
    		...
    		Plate returned = subtraction.platesStrict(plate1, inputList, begin, end - begin);
    		Plate returnedUneven = subtraction.platesStrict(plate1, inputListUneven, begin, end - begin);
    ...
    public void testSets() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, false);
    		WellSet returned = subtraction.sets(set1, set2);
    		WellSet returnedUneven = subtraction.sets(set1, setUneven);
    ...
    public void testSetsIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, false);
    		WellSet returned = subtraction.sets(set1, set2, begin, end - begin);
    		WellSet returnedUneven = subtraction.sets(set1, setUneven, begin, end - begin);
    ...
    public void testSetsStrict() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, true);
    		WellSet returned = subtraction.setsStrict(set1, set2);
    		WellSet returnedUneven = subtraction.setsStrict(set1, setUneven);
    ...
    public void testSetsStrictIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet[] result = this.set(set1, set2, setUneven, begin, end, true);
    		WellSet returned = subtraction.setsStrict(set1, set2, begin, end - begin);
    		WellSet returnedUneven = subtraction.setsStrict(set1, setUneven, begin, end - begin);
    ...
    public void testSetConstant() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set, randomBigDecimal);
    ...
    public void testSetArray() {   	
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set1, array);
    		WellSet returnedUneven = subtraction.sets(set1, arrayUneven);
    ...
    public void testSetArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set1, array, begin, end - begin);
    		WellSet returnedUneven = subtraction.sets(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetCollection() {   
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set1, inputList);
    		WellSet returnedUneven = subtraction.sets(set1, inputListUneven);
    ...
    public void testSetCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.sets(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = subtraction.sets(set1, inputListUneven, begin, end - begin);
    ...
    public void testSetStrictArray() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.setsStrict(set1, array);
    		WellSet returnedUneven = subtraction.setsStrict(set1, arrayUneven);
    ...
    public void testSetStrictArrayIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.setsStrict(set1, array, begin, end - begin);
    		WellSet returnedUneven = subtraction.setsStrict(set1, arrayUneven, begin, end - begin);
    ...
    public void testSetStrictCollection() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.setsStrict(set1, inputList);
    		WellSet returnedUneven = subtraction.setsStrict(set1, inputListUneven);
    ...
    public void testSetStrictCollectionIndices() {
    	...
    	for(int i = 0; i < plates1.length; i++) {
    		...
    		WellSet returned = subtraction.setsStrict(set1, inputList, begin, end - begin);
    		WellSet returnedUneven = subtraction.setsStrict(set1, inputListUneven, begin, end - begin);
    ...
    public void testStacks() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, stack2);
	    	Stack returnedUneven = subtraction.stacks(stack1, stackUneven);
    ...
    public void testStacksIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacks(stack1, stackUneven, begin, end - begin);
    ...
    public void testStacksStrict() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, stack2);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, stackUneven);
    ...
    public void testStacksStrictIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, stack2, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, stackUneven, begin, end - begin);
    ...
    public void testStackConstant() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	while(stackIter1.hasNext()) {
	    		...
	    		for(Well well : plate) {
	    			...
	    			for(BigDecimal bd : well) {
	    				resultList.add(bd.subtract(randomBigDecimal));
	    			}
	    	...
	    	Stack returned = subtraction.stacks(stack1, randomBigDecimal);
    ...
    public void testStackArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, array);
	    	Stack returnedUneven = subtraction.stacks(stack1, arrayUneven);
    ...
    public void testStackArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, array, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacks(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, inputList);
	    	Stack returnedUneven = subtraction.stacks(stack1, inputListUneven);
    ...
    public void testStackCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacks(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacks(stack1, inputListUneven, begin, end - begin);
    ...
    public void testStackStrictArray() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, array);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, arrayUneven);
    ...
    public void testStackStrictArrayIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, array, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, arrayUneven, begin, end - begin);
    ...
    public void testStackStrictCollection() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, inputList);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, inputListUneven);
    ...
    public void testStackStrictCollectionIndices() {
    	...
    	for(int k = 0; k < stacks1.size(); k++) {
	    	...
	    	Stack returned = subtraction.stacksStrict(stack1, inputList, begin, end - begin);
	    	Stack returnedUneven = subtraction.stacksStrict(stack1, inputListUneven, begin, end - begin);
