...
public class WellSetTest {
    ...
    public void testAddWell() { 
    	...
    	Well well = RandomUtil.randomWellBigDecimal(minValue, 
    			maxValue, minRow, maxRow, minColumn, maxColumn, minLength, maxLength);
    ...
    public void testRemoveWell() {
    	...
    	Well notCommon = RandomUtil.randomWellBigDecimal(minValue, 
    ...
    public void testReplace() {
    	...
    	Well random = (Well) RandomUtil.randomObject(testSet.allWells());
    	Well replace = new Well(random.row(), random.column(), RandomUtil.randomBigDecimalList(minValue, maxValue, minLength, maxLength));
    ...
    public void testGetRow() {
    	...
    	for(int i = 0; i < wellNum; i++) {
    		Well well = RandomUtil.randomWellBigDecimal(minValue, maxValue, 
