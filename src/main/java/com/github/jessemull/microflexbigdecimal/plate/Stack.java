...
public class Stack implements Iterable<Plate> {
     ...
     * @param    Collection<PlateBigDecimal>    list of input plates
     */
     ...
     * @param    Collection<PlateBigDecimal>    the input plates
     * @result   Collection<PlateBigDecimal>               the output plates
     */
