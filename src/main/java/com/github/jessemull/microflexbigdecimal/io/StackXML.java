...
public class StackXML {
    ...
    private List<PlateXML> plates = 
    		new ArrayList<PlateXML>();   // List of plates in the stack
     ...
     * @param    List<PlateXMLBigDecimal>    the plates
     */
    ...
    /**
     * Returns a StackBigDecimal object.
     * @return    the stack
     */
