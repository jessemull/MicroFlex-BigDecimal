...
public class ResultXML {
    ...
    private List<ResultWellXML> wells = new ArrayList<ResultWellXML>();    // Array holding the well values
     ...
     */
    public ResultXML(Map<Well, BigDecimal> map, String label) {
    ...
    /**
     * Sets the wells list.
     * @param    List<ResultWellXMLBigDecimal>    the wells list
     */
