...
public class ResultListXML implements Iterable<ResultXML>{
     ...
     */
    public ResultListXML(Map<Well, BigDecimal> map) {
     ...
     */
    public ResultListXML(Map<Well, BigDecimal> map, String label) {
     ...
     */
    public ResultListXML(Collection<Map<Well, BigDecimal>> collection) {
    	
    	int index = 1;
    	
        for(Map<Well, BigDecimal> map : collection) {
     ...
     */
    public ResultListXML(Collection<Map<Well, BigDecimal>> collection, List<String> labels) {
