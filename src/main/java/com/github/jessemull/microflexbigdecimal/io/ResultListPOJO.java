...
public class ResultListPOJO implements Iterable<ResultPOJO> {
     ...
     * @param    Map<WellBigDecimal, BigDecimal>    the input results
     */
    public ResultListPOJO(Map<Well, BigDecimal> results) {
     ...
     * @param    Map<WellBigDecimal, BigDecimal>    the input results
     */
    public ResultListPOJO(Map<Well, BigDecimal> results, String label) {
        this.results.add(new ResultPOJO(results, label));
    }
    
    /**
     * Creates a result list POJO from a collection of well objects.
     * @param    Collection<Map<WellBigDecimal, BigDecimal>>    collection of results
     */
    public ResultListPOJO(Collection<Map<Well, BigDecimal>> collection) {
        for(Map<Well, BigDecimal> result : collection) {
     ...
     */
    public ResultListPOJO(Collection<Map<Well, BigDecimal>> collection, List<String> labels) {
    	int index = 0;
        for(Map<Well, BigDecimal> result : collection) {
     ...
     * @param    List<ResultPOJOBigDecimal>    the new list of results
     */
