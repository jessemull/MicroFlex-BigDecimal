...
public abstract class DescriptiveStatistic {
     ...
     */
    public Map<Well, BigDecimal> plate(Plate plate) {
     ...
     * @return                      map of wells and results   
     */
    public Map<Well, BigDecimal> plate(Plate plate, int begin, int length) {
     ...
     */
    public Map<Plate, BigDecimal> platesAggregated(Collection<Plate> collection) {
     ...
     */
    public Map<Plate, BigDecimal> platesAggregated(Plate[] array) {
    ...
    public Map<Plate, BigDecimal> platesAggregated(
        ...
        for(Plate plate : collection) {
            ...
            results.put(clone, calculate(aggregated, begin, length));
     ...
     * @return                        map of wells and results
     */
    public Map<Well, BigDecimal> set(WellSet set) {
     ...
     * @return                        map of wells and results
     */
    public Map<Well, BigDecimal> set(WellSet set, int begin, int length) {
     ...
     */
    public Map<WellSet, BigDecimal> setsAggregated(Collection<WellSet> collection) {
     ...
     * @return                          map of well sets and aggregated results
     */
    public Map<WellSet, BigDecimal> setsAggregated(WellSet[] array) {
     ...
     * @return                       the result
     */
    public abstract BigDecimal calculate(List<BigDecimal> list, int begin, int length);
}
