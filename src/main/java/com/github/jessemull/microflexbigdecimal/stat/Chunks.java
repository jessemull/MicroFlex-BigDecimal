...
/**
 * This splits up big decimal plate stacks, plates, wells and well sets into sublists
 * of size p.
 * 
 * <br>
 * 
 ...
 */
public class Chunks extends QuantileStatisticListContext {

    /* --------------- Methods for splitting lists into chunks -------------- */
