...
/**
 * This class returns the range for big decimal plate stacks, plates, wells and well sets.
 * 
 * <br><br>
 * 
 ...
 */
public class Range extends DescriptiveStatistic {
    ...
    public BigDecimal calculate(List<BigDecimal> list, int begin, int length) {
        return Collections.max(list.subList(begin, begin + length));            
    }
