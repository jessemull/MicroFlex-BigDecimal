...
/**
 * This class calculates the sample standard deviation of big decimal plate 
 ...
 */
public class SampleStandardDeviation extends DescriptiveStatisticContext {
	...
	public BigDecimal calculate(List<BigDecimal> list, MathContext mc) {
    	...
    	sum = sum.divide(new BigDecimal(list.size() - 1), mc);
