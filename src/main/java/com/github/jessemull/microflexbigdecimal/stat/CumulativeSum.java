...
/**
 * This class calculates the cumulative sum of big decimal plate stacks, plates, 
 * wells and well sets.
 *
 * <br><br>
 * 
 ...
 */
public class CumulativeSum extends DescriptiveStatisticListWeightsContext {
    ...
    public List<BigDecimal> calculate(List<BigDecimal> list, double[] weights, MathContext mc) {
    	...
    	for(int i = 0; i < list.size(); i++) {
    		sum = sum.add(list.get(i).multiply(new BigDecimal(weights[i]), mc));
    		result.add(sum);
    	}
