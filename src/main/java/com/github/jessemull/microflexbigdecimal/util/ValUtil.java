...
public class ValUtil {
     ...
     */
    public static void validatePlateBigDecimal(Plate plate1, Plate plate2) {
     ...
     */
    public static void validatePlateBigDecimal(Plate plate1, Collection<Plate> collection) {
     ...
     */
    public static void validatePlateBigDecimal(Plate plate1, Plate[] array) {
     ...
     * @param    Plate    the second plate
     */
    public static void validatePlateBigDecimal(int rows, int columns, Plate plate) {
     ...
     * @param    Collection<PlateBigDecimal>    the plate collection
     */
    public static void validatePlateBigDecimal(int row, int column, Collection<Plate> collection) {
     ...
     * @param    PlateBigDecimal[]    the plate array
     */
    public static void validatePlateBigDecimal(int row, int column, Plate[] array) {
